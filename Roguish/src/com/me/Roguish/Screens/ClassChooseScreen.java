...
public class ClassChooseScreen extends AbstractScreen{
	TextureAtlas guiAtlas;
	TextureAtlas entAtlas;
	
	public ClassChooseScreen(Roguish game){
		super(game);
	}
    ...
    public void show(){
		...
		guiAtlas = new TextureAtlas(Gdx.files.internal("data/entity/pack/Entities.pack"));
